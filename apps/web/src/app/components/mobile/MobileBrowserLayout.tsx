...
function MobileBrowserLayout({
  ...
  return (
    <div className="flex flex-col w-full h-full p-3 gap-3">
      <div className="flex-1 min-h-0 flex flex-col mobile-tile bg-[#0d0e10]">
          ...
          <div className="px-3 py-2 mobile-glass-soft border-b border-[#FEFCD9]/10">
            ...
            >
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-full bg-[#5B7CFA] text-white text-xs font-medium hover:bg-[#5B7CFA]/90 disabled:opacity-40 disabled:hover:bg-[#5B7CFA]"
              >
                {isBrowserLaunching ? (
            ...
            {navError && (
              <p className="mt-1 text-[10px] text-[#5B7CFA]">{navError}</p>
            )}
          </div>
        )}
        ...
        <div className="flex-1 min-h-0 relative bg-black">
          {isReady ? (
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-gradient-to-br from-[#1a1b1f] to-[#0d0e10]">
              <div className="w-14 h-14 rounded-full bg-[#5B7CFA]/10 flex items-center justify-center">
                <Globe className="w-7 h-7 text-[#5B7CFA] animate-pulse" />
              </div>
        ...
        <div className="flex items-center justify-between px-3 py-2 mobile-glass-soft border-t border-[#FEFCD9]/10">
          <div className="flex items-center gap-2">
            <div className="w-5 h-5 rounded-full bg-[#5B7CFA]/20 flex items-center justify-center">
              <Globe className="w-2.5 h-2.5 text-[#5B7CFA]" />
            </div>
            <span
          ...
          >
            ...
            >
              <span className="mobile-name-pill px-1.5 py-0.5 text-[10px] text-[#FEFCD9] font-medium uppercase tracking-[0.18em] truncate max-w-full flex items-center gap-1 backdrop-blur-md">
                ...
                {participant.isMuted && (
                  <MicOff className="w-2.5 h-2.5 text-[#5B7CFA]" />
                )}
              </span>
            </div>
