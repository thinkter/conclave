...
function DeviceDropdown({
  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      {isDropdownOpen && (
        <div className="absolute top-full left-0 right-0 mt-1 bg-[#0d0e10] border border-[#FEFCD9]/10 rounded-md max-h-32 overflow-y-auto z-50 shadow-xl">
          {devices.length === 0 ? (
            ...
            devices.map((device) => (
              ...
              >
                ...
                {(device.deviceId === selectedDeviceId ||
                  ...
                  <Check className="w-3 h-3 text-[#5B7CFA] shrink-0" />
                )}
              </button>
            ))
          )}
...
export default function VideoSettings({
  ...
  return (
    <div ref={containerRef} className="relative" style={{ fontFamily: "'PolySans Trial', sans-serif" }}>
      ...
      {isOpen && (
        <div className="absolute top-full right-0 mt-2 bg-[#0d0e10]/95 backdrop-blur-md border border-[#FEFCD9]/10 rounded-lg p-2 w-72 z-50 shadow-2xl">
            ...
            <div className="ml-auto">
              <div
                className={`w-8 h-5 rounded-full transition-all relative ${
                  isMirrorCamera ? "bg-[#5B7CFA]" : "bg-[#FEFCD9]/20"
                }`}
              >
                <div
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center gap-2 rounded-lg border px-2.5 py-2 text-left transition-colors ${
                          isSelected
                            ? "border-[#5B7CFA]/50 bg-[#5B7CFA]/10 text-[#FEFCD9]"
                      ...
                      >
                        ...
                        {isSelected ? (
                          <Check className="h-3.5 w-3.5 shrink-0 text-[#5B7CFA]" />
                        ) : null}
                      </button>
                    );
                  })}
            ...
            <div className="px-3 py-2">
              ...
              >
                <input
                  ...
                  maxLength={40}
                  className="flex-1 px-2 py-1.5 bg-black/40 border border-[#FEFCD9]/15 rounded-md text-xs text-[#FEFCD9] focus:outline-none focus:border-[#5B7CFA] transition-colors placeholder:text-[#FEFCD9]/30"
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-[10px] rounded-md bg-[#5B7CFA] text-white disabled:opacity-50 transition-all"
                >
